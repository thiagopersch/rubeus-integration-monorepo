...
const labelModifiers = {
  inFocusOrValue: (theme: DefaultTheme, disabled: boolean) => css`
    box-shadow: inset 0rem 0rem 0rem 0.2rem
      ${disabled ? theme.colors.lightGrey : theme.colors.primaryColor};
    ...
    span {
      ...
      color: ${disabled ? theme.colors.lightGrey : theme.colors.primaryColor};
    }
  `,
  disabled: () => css`
...
export const Label = styled.label<LabelProps>`
  ${({ theme, hasValue, inputAs, isDisabled }) => css`
    ...
    box-shadow: inset 0rem 0rem 0rem 0.1rem ${theme.colors.lightGrey};
